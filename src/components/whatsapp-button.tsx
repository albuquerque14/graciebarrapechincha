...
export function FloatingWhatsApp() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="animate-whatsapp-pulse fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl shadow-black/60 md:h-16 md:w-16"
    >
...
export function WhatsAppCTA({
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.97 }}
      className={`inline-flex items-center justify-center gap-3 rounded-full bg-[#25D366] font-bold uppercase tracking-wider text-white shadow-xl shadow-[#25D366]/30 transition-shadow hover:shadow-2xl hover:shadow-[#25D366]/50 ${sizes[size]} ${className}`}
