...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://graciebarrapechincha.lovable.app/assets/hero-group.jpg" },
      { name: "twitter:image", content: "https://graciebarrapechincha.lovable.app/assets/hero-group.jpg" },
    ],
    links: [
      {
        rel: "stylesheet",
