...
const kidsImg = "/assets/avancado.jpg";
...
const competicaoImg = "/assets/nogi.jpg";
  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y }} className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/40 via-black/10 to-black/35" />
        {/* red scan line */}
    ...
    <FadeIn delay={delay}>
      ...
      >
        <motion.img
          ...
          loading="lazy"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/80 via-30% to-transparent to-55%" />
        <motion.div
